...
namespace Presentation.Public
{
	...
	public partial class MyMessageBox : BaseForm
	{
		public MyMessageBox()
		{
			InitializeComponent();
		...
		private void pcbExpand_Click(object sender, EventArgs e)
		{
            ...
            if (isShowExpandMessage)
            {
                ...
                myMessage.Size = new Size(489, 255);
            }
            else
            {
                myMessage.lblInformation.Visible = false;
                myMessage.Size = new Size(489, 167);
            }
		}
		...
		public static void SetIconMessage(MyDialogIcon icon)
		{
			switch (icon)
			{
				case MyDialogIcon.Error:
					myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Error;
					break;
				case MyDialogIcon.Information:
                    myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Information_2;
					break;
				case MyDialogIcon.OK:
                    myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Check;
					break;
				case MyDialogIcon.Question:
                    myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Question;
					break;
				case MyDialogIcon.Warning:
                    myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Warning;
					break;
				default:
                    myMessage.pcbIcon.Image = Presentation.Properties.Resources.Symbol_Check;
					break;
